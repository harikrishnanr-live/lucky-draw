            ...
            if ($checkResult->num_rows > 0) {
                ...
                if ($emailResult->num_rows > 0) {
                    ...
                    if (empty($message)) {
                        ...
                        $insertStmt = $conn->prepare("INSERT INTO users (user_code, username, password, email, full_name, phone, company, logo, common_title, year, background_image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                        $insertStmt->bind_param("sssssssssss", $userCode, $username, $hashedPassword, $email, $fullName, $phone, $company, $logoPath, $commonTitle, $year, $backgroundPath);
...
<div class="container">
    <div class="form-container">
        ...
        <p>Fill in the details below to create a new user account with a unique customer code.</p>
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">Optional: User's full name</div>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="form-hint">Optional: Contact phone number</div>
                </div>

                <div class="form-group">
                    <label for="company">Company</label>
                    <input type="text" id="company" name="company" value="<?php echo htmlspecialchars($company ?? ''); ?>">
                    <div class="form-hint">Optional: Company or organization name</div>
                </div>
            </div>
